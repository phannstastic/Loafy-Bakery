                            ...
                            <table class="table table-hover mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="px-4 py-3">Rp. <?php echo number_format($total_harga, 0, ',', '.'); ?></td>
                                        <td class="px-4 py-3">
                                            <div class="btn-group">
                    ...
                    <div class="card-body">
                        ...
                        <hr>
                            <div class="d-flex justify-content-between mb-3">
                                ...
                                <span class="fw-bold text-primary">Rp. <?php echo number_format($total_semua, 0, ',', '.'); ?></span>
                            </div>
                        <hr>
                        <div class="d-grid">
                            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#checkoutModal">
                                <i class="bi bi-cart-check me-2"></i>Proses
                            </button>
                        </div>
                    </div>
                </div>
...
<div class="modal fade" id="checkoutModal" tabindex="-1" aria-labelledby="checkoutModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="checkoutModalLabel">Konfirmasi Pemesanan</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                ...
                <h5 class="text-center mb-3">Anda akan melakukan Proses Pemesanan Ini</h5>
            ...
            <div class="modal-footer">
                ...
                <a href="proses_checkout.php" class="btn btn-primary">
                    <i class="bi bi-cart-check me-2"></i>Ya, Proses Sekarang
                </a>
            </div>
        </div>
    </div>
